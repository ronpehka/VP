<?php
	class Photoupload{
		...
		public function makeFileName($prefix){
			...
			$this->fileName = $filenameprefix .$timestamp ."." .$this->filetype;
		}
		
		public function checkForFileType(){
			if($this->photofiletype != "jpg" and $this->photofiletype!= "png" and $this->photofiletype != "jpeg"
			and $this->photofiletype != "gif" ) {
